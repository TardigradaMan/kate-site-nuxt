        ...
        <li class="agree__item">
          ...
          <ol class="agree__sublist">
            ...
            <li class="agree__subitem">
              ...
              электронной почты libertyadt@ya.ru с пометкой «Отказ от
        ...
        <li class="agree__item">
          ...
          <ol class="agree__sublist">
            ...
            <li class="agree__subitem">
              ...
              libertyadt@ya.ru с пометкой «Актуализация персональных данных».
            </li>
            <li class="agree__subitem">
              ...
              libertyadt@ya.ru с пометкой «Отзыв согласия на обработку
              персональных данных».
            </li>
          </ol>
        </li>
