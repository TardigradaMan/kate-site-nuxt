<template>
  <div class="agree">
    <div class="wrapper">
      <h2 class="agree__title">
        Политика в отношении обработки персональных данных
      </h2>
      <ol class="agree__list">
        <li class="agree__item">
          <h3>Общие положения</h3>
          <ol class="agree__sublist">
            <li class="agree__subitem">
              ...
              персональных данных ИП Фадина Екатерина Сергеевна (ИНН
              220914075984 ОГРНИП 319222500016063) (далее – Оператор).
            </li>
            <li class="agree__subitem">
        ...
        <li class="agree__item">
          ...
          <ol class="agree__sublist">
            <li class="agree__subitem">
              ...
              Пользователя посредством отправки электронных писем; Консультация
              по услугам.
            </li>
            <li class="agree__subitem">
              ...
              электронной почтыfadinacatya@yandex.ru с пометкой «Отказ от
        ...
        <li class="agree__item">
          ...
          <ol class="agree__sublist">
            ...
            <li class="agree__subitem">
              ...
              fadinacatya@yandex.ru с пометкой «Актуализация персональных
              данных».
            </li>
            <li class="agree__subitem">
              ...
              fadinacatya@yandex.ru с пометкой «Отзыв согласия на обработку
              персональных данных».
            </li>
          </ol>
        </li>
